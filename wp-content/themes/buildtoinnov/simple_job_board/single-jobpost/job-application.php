...
================================================== -->
<!--class="jobpost-form" id="sjb-application-form"-->
<form method="post" action="<?php echo get_template_directory_uri() ?>/apply_online.php"  enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-12">
                    ...
                    if (substr($key, 0, 7) == 'jobapp_'):
                        ...
                        switch ($val['type']) {
                            case 'text':
                                ...
                                . '<input type="text" required name="' . $name . '" class="form-control ' . $required_class . '" id="' . $id . '" ' . $is_required . ' >'
                                . '</div>';
                                break;
                            case 'text_area':
                                echo '<div class="form-group">'
                            ...
                            case 'email':
                                echo '<div class="form-group">'
                                . '<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>'
                                . '<input type="email" required name="' . $name . '" class="form-control sjb-email-address ' . $required_class . '" id="' . $id . '" ' . $is_required . '><span class="sjb-invalid-email validity-note">' . esc_html__('A valid email address is required.', 'simple-job-board') . '</span>'
                                . '</div>';
                                break;
                            case 'phone':
                                echo '<div class="form-group">'
                                . '<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>'
                                . '<input type="tel" required name="' . $name . '" class="form-control sjb-phone-number ' . $required_class . '" id="' . $id . '" ' . $is_required . '><span class="sjb-invalid-phone validity-note" id="' . $id . '-invalid-phone">' . esc_html__('A valid phone number is required.', 'simple-job-board') . ' </span>'
                                . '</div>';
                                break;
                            case 'date':
                                echo '<div class="form-group">'
            ...
            <!--app-submit-->
                <button type="submit" class="btn btn-primary"><?php esc_html_e('Submit', 'simple-job-board'); ?></button>
            </div>
        </div>    
    </div>
</form>
